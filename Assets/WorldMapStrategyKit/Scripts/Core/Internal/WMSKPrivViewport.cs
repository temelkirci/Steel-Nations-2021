...
namespace WorldMapStrategyKit {
    ...
    public partial class WMSK : MonoBehaviour {
        ...
        void EarthGetElevationInfo() {
            ...
            if (viewportElevationPoints == null || viewportElevationPoints.Length != size || _heightMapTexture == null || _heightMapTexture.width != heightmapTextureWidth) {
            ...
            if (extrudedRegionCount > 0) {
                ...
                for (int j = 0; j < heightmapTextureHeight; j++) {
                    ...
                    for (int k = 0; k < heightmapTextureWidth; k++) {
                        ...
                        float gCol = heightMapColors[pos].r - baseElevation;
                        if (gCol < 0)
                            gCol = 0;
